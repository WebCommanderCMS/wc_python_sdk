...
from wc_py.webcommander.common.dto.shipping_rates_dto import *
from wc_py.webcommander.shipping_rates.admin.admin_shipping_rates_api_url import AdminShippingRatesApiUrl
